...
const AdminTaskCalender = ({projectTasks,projectId}) => {
    ...
    const initializeTasks = () => {
        ...
        projectTasks = projectTasks.filter((task) => task.status !== "completed");
                    ...
                    >
                        <Flex w="100%" flexDir={'column'} justify="center" align="start">
                            <Flex w="100%" justify="space-between" align="center">
                                <Text w="100%" textAlign="left" as={'span'}>
                                    {task.name}
                                </Text>

                            </Flex>
                            <Badge colorPalette={'orange'}>
                                {task.assignedTo !== null ? `${task.assignedTo.name}` : "Not Assigned"}
                            </Badge>
...
export default AdminTaskCalender;
